...
contract SalientYachtsSYONE_v04 is ERC721, ERC721Enumerable, ERC721URIStorage, Ownable {
    ...
    uint16  private constant SUPPLY_LIMIT           = 15000; //assume Yacht price is $1,500,000 -> we will have 15000 tokens at $100 each
    ...
    function initNFTPrice(uint8 _decimals, NFTTypeData storage _nftTypeData) internal {
        ...
        int256 newPrice = (int256(NFT_MINT_PRICE_USD) * decimals) / basePrice;
